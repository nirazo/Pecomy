...
extension UINavigationController {
    func makeNavigationBarTranslucent() {
        ...
        self.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: Const.PECOMY_THEME_TEXT_COLOR]
    ...
    func makeNavigationBarDefault(){
        ...
        self.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: Const.PECOMY_THEME_COLOR]
    }
}
